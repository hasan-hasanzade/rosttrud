        ...
        function headerMainActions(e) {
            ...
            if (targetElement.closest("[data-parent-main]")) {
                ...
                if (subMenu) {
                    ...
                    if (activeLink && activeLink !== targetElement) {
                        activeLink.classList.remove("_sub-main-menu-active");
                        activeBlock.classList.remove("_sub-main-menu-open");
                        document.documentElement.classList.remove("sub-main-menu-open");
                    }
                    document.documentElement.classList.toggle("sub-main-menu-open");
                    targetElement.classList.toggle("_sub-main-menu-active");
                    subMenu.classList.toggle("_sub-main-menu-open");
                } else console.log("Ой ой, нет такого подменю :(");
                e.preventDefault();
            }
        }
